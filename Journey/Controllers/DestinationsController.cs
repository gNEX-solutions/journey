            ...
            try
            {
                var data = from d in _journyDb.Destinations
                           ...
                           select new
                           {
                               ...
                               d.VisitedOn,
                               d.IsPublished,
                               d.DestinationCatogary.DestinationCatogaryId,
                               d.DestinationCatogary.CatagoryName,
                               d.user.userId,
                               d.user.Username,
                               d.DestinationTravellingMode.DestinationTravellingModeId,
                               d.DestinationTravellingMode.TravellingMode,
                               d.AdminId,
